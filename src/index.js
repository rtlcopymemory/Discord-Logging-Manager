...
client.on('guildMemberUpdate', async (oldMember, newMember) => {
    onGuildLogging(newMember.guild, async (logChannels) => memberUpdateHandler(oldMember, newMember, logChannels));
});

client.on('messageDelete', async message => {
    onGuildLogging(message.guild, async (logChannels) => messageDeleteHandler(message, logChannels));
});
